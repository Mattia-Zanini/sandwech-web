        ...
        <div class="row g-0">
            <div class="col-4 offset-1">
                <img class="img-fluid login-card-shadow"
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/panino4.jpeg" alt="photo"
            ...
            <div class="col-6 login-card-shadow" style="border-radius: 0px 25px 25px 0px; background-color: white;">
                <div class="col-8 offset-1">
                    <div class="row">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png"
